...
##Buttons
#et_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { reset_button }]; #IO_L8P_T1_34 Schematic=BTN0
...
#
##cathodes
#set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { cathode_a }]; #IO_L20P_T3_AD6P_35 Schematic=SSEG_CA
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { cathode_b }]; #IO_L19P_T3_35 Schematic=SSEG_CB
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { cathode_c }]; #IO_L14P_T2_AD4P_SRCC_35 Schematic=SSEG_CC
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { cathode_d }]; #IO_25_35 Schematic=SSEG_CD
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { cathode_e }]; #IO_L8P_T1_AD10P_35 Schematic=SSEG_CE
#set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { cathode_f }]; #IO_L24N_T3_AD15N_35 Schematic=SSEG_CF
#set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports { cathode_g }]; #IO_L8P_T1_AD10P_35 Schematic=SSEG_CG
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { cathode_dp }]; #IO_L12N_T1_MRCC_35 Schematic=SSEG_DP
